...
export const en: Record<string, string> = {
  ...
  "settings.maintenance.modelOverridePlaceholder": "Empty: use configured model",
  "settings.maintenance.modelOverrideHelp": "Only fill this in to pin a specific provider model ID.",
