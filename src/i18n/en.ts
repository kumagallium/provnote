...
export const en: Record<string, string> = {
  ...
  "settings.maintenance.atomize.title": "Generate Atoms from existing Concepts",
  "settings.maintenance.atomize.help": "Iterate over all Concepts ({count}) and produce one Atom each. Concepts that already have an Atom derived from them are skipped automatically.",
  "settings.maintenance.atomize.confirm": "Atomize {count} Concepts? This will call the LLM and may take a while.",
  "settings.maintenance.atomize.run": "Generate Atoms",
