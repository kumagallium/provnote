...
export const en: Record<string, string> = {
  ...
  "settings.maintenance.synthesize.help": "Scan all {count} Atoms at once and surface emergent insights that arise from combining two or more of them. Existing Syntheses are sent to the model to avoid duplicates.",
  "settings.maintenance.synthesize.confirm": "Discover Syntheses across {count} Atoms? This calls the LLM and may iterate up to 5 times.",
