...
export const ja: Record<string, string> = {
  ...
  "settings.tab.experimental": "実験的機能",
  "settings.tab.maintenance": "メンテナンス",
  "settings.experimental.title": "実験的機能",
  "settings.experimental.intro": "これらは不安定で予告なく変更される可能性があります。トグルの状態に関わらず、既存ページのファイルはそのまま保持されます。",
  "settings.experimental.atom.title": "Atom レイヤ",
  "settings.experimental.atom.help": "Concept の上に Zettelkasten 的な抽象層を追加します。1 つ以上の Concept を出自から切り離し、単一のアイデアに凝縮します。",
  "settings.experimental.synthesis.title": "Synthesis（Atom レイヤが必要）",
  "settings.experimental.synthesis.help": "Synthesis ページを再有効化します（ソースは Concept ではなく Atom）。依存連鎖の脆さを避けるため既定はオフ。",
  ...
  "settings.maintenance.atomize.title": "Concept をまたぐ Atom を発見",
  "settings.maintenance.atomize.help": "{count} 件の Concept を一度にスキャンし、2 つ以上の Concept にまたがって現れる抽象アイデアを抽出します。既存 Atom はモデルに渡して重複提案を抑えます。",
  "settings.maintenance.atomize.confirm": "{count} 件の Concept から Atom を発見しますか？ LLM を 1 回呼びます。",
  "settings.maintenance.atomize.run": "Atom を発見",
  "settings.maintenance.atomize.running": "発見中…",
  "settings.maintenance.atomize.discovering": "{count} 件の Concept から共通抽象を探しています…",
  "settings.maintenance.atomize.doneCount": "{count} 件の新規 Atom を作成しました。",
  "settings.maintenance.synthesize.title": "Atom をまたぐ Synthesis を発見",
  "settings.maintenance.synthesize.help": "{count} 件の Atom をスキャンし、2 つ以上を組み合わせて立ち上がる新しい洞察を発見します。組み合わせは原理的に無限なので少量ずつ生成します。続きが欲しいときはもう一度押してください。",
  "settings.maintenance.synthesize.confirm": "{count} 件の Atom から Synthesis を発見しますか？ 1 クリックで LLM を最大 3 回呼びます。",
  "settings.maintenance.synthesize.run": "Synthesis を発見",
  "settings.maintenance.synthesize.running": "発見中…",
  "settings.maintenance.synthesize.discovering": "{count} 件の Atom から新しい洞察を探しています…",
  "settings.maintenance.synthesize.doneCount": "{count} 件の新規 Synthesis を作成しました。",
  ...
  "wikiList.colSourcesTooltip": "この Wiki が派生したソースノート数",
  "wikiList.colOutgoing": "参照先",
  "wikiList.colOutgoingTooltip": "この Wiki が参照しているノート/Wiki 数",
  "wikiList.colIncoming": "被参照",
  "wikiList.colIncomingTooltip": "他のノート/Wiki から参照されている数",
  "wikiList.colModel": "モデル",
  "wikiList.colCreated": "作成日",
  "wikiList.colModified": "更新日",
  "wikiList.search": "検索...",
  "wikiList.count": "({filtered}/{total})",
  "wikiList.deleteSelected": "{count} 件削除",
  "wikiList.deleteConfirmTitleSingle": "Wiki を削除しますか？",
  "wikiList.deleteConfirmTitleMulti": "{count} 件の Wiki を削除しますか？",
  "wikiList.deleteConfirmMessage": "この操作は取り消せません。",
  "wikiList.deleteConfirmCancel": "キャンセル",
  "wikiList.deleteConfirmOk": "削除",
  "wikiList.deleting": "削除中…",
  "wikiList.deleteRowTitle": "削除",
  "wikiList.loading": "読み込み中...",
  "wikiList.noMatching": "一致する Wiki がありません",
  "wikiList.noWikisYet": "{kind} の Wiki はまだありません",
