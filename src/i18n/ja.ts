...
export const ja: Record<string, string> = {
  ...
  "settings.maintenance.atomize.title": "既存 Concept から Atom を生成",
  "settings.maintenance.atomize.help": "Concept ({count} 件) を順番に Atom 化します。すでに Atom が紐づいている Concept は自動でスキップされます。",
  "settings.maintenance.atomize.confirm": "{count} 件の Concept を Atom 化しますか？ LLM を呼ぶため時間がかかります。",
  "settings.maintenance.atomize.run": "Atom を生成",
