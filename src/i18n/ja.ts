...
export const ja: Record<string, string> = {
  ...
  "settings.maintenance.synthesize.help": "{count} 件の Atom を一度にスキャンし、2 つ以上を組み合わせて立ち上がる新しい洞察を発見します。既存 Synthesis はモデルに渡して重複提案を抑えます。",
  "settings.maintenance.synthesize.confirm": "{count} 件の Atom から Synthesis を発見しますか？ LLM を最大 5 回呼びます。",
